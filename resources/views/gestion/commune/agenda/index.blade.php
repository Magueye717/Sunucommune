...
@section('filAriane')
    <li class="active">Gestion de l'agenda</li>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">Agenda mairie</h3>
                <p class="text-muted m-b-10">Liste des activités</p>
                        ...
                        <a href="{{ route('agendas.create') }}">
                            <span class="pull-right m-b-10">
                                <button class="btn btn-primary btn-block m-b-10">
                                    <i class="ti-plus m-r-5"></i> Ajouter une activité
                                </button>
                            </span>
                        </a>
                    </div>
                ...
                @include('gestion.commune.agenda.partials._liste')
            </div>
        </div>
    </div>
@endsection
