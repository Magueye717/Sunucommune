...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">Gestion des Media</h3>
                <p class="text-muted m-b-20">Création</p>

                {!! Form::model(new App\Models\Commune\Mediatheque(), ['route' => ['mediatheques.store'], 'role' => 'form',
                'class' => 'sunucommune-form', 'data-toggle' => 'validator', 'files' => 'true']) !!}
                @include('gestion.commune.mediatheques.partials._form')
                {!! Form::close() !!}
            </div>
        </div>
    </div>
