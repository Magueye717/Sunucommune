...
@section('filAriane')
    <a class="breadcrumb-item" href="{{ route('thematiques.index') }}">thematiques</a>
    <a class="breadcrumb-item active" href="#">Liste des thematiques</a>
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                ...
                <p class="text-muted m-b-10">thematiques</p>

                {{-- Actions disponibles --}}
                <div class="row">
                    <div class="col-md-12 m-b-15">
                        <div class="d-inline pull-right">
                            <a href="{{ route('thematiques.create') }}"
                               class="btn btn-primary btn-wth-icon">
                                <i class="ti-plus m-r-5"></i> Ajouter un thematique
                            </a>
                        </div>
                    </div>
                </div>
                {{-- Liste des comités --}}
                @include('gestion.participation.thematique.partials._liste')
            </div>
        </div>
    </div>
@endsection
