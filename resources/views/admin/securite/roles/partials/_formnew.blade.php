<div class="form-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label class="control-label">Permissions <span class="text-danger">*</span></label>
                {!! Form::text('permissions', null, ['id' => 'permission', 'class' => 'form-control', 'required' => '', 'placeholder' => 'Permissions',
                    (isset($permission)) ? 'disabled' : '']) !!}
                <div class="help-block with-errors"></div>
            </div>
        </div>
