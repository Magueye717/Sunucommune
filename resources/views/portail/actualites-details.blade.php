...
<section class="blog-details-page mt-50 rmt-100 mb-135 rmb-95">
    ...
    <h2 class="mb-40">Electronic Security Systems for Homes and Businesses</h2>
    ...
    <h3 class="inner-title">Similaire Post</h3>
    ...
    <div class="latest-news-content">
    <h3><a href="blog-details.html">Keeping First Responders Safe</a></h3>
    <span class="date">14 Aug, 2019</span> <p>Morbi interdum mollis sapien. Sed ac risus. Phasellus lacinia, mag ullamcorper laoreet, lectus arcu pulvinar risus, vitae.</p>
    <ul class="blog-statistics">
    <li><i class="flaticon-share"></i>126</li>
    <li><i class="flaticon-eye"></i>400</li>
    <li><i class="flaticon-speech-bubbles"></i>20</li>
    ...
    <h3 class="inner-title">Comment</h3>
    <div class="comment-item">
    <div class="comment-img">
    <img src="assets/images/blog/comment-1.png" alt="Commenter">
    </div>
    <div class="comment-content">
    <h6>Robert Down</h6>
    <span class="date">1 Days Ago</span>
    <p>Morbi interdum mollis sapien. Sed ac risus. Phasellus lacinia, magna a ullamcorper laoreet, lectus arcu pulvinar risus, vitae facilisis libero dolor a purus. Sed vel lacus. Mauris nibh felis,</p>
    <a href="#" class="replay">Replay</a>
    </div>
    </div>
    <div class="comment-item replay-comment">
    <div class="comment-img">
    <img src="assets/images/blog/comment-2.png" alt="Commenter">
    </div>
    <div class="comment-content">
    <h6>Ramiro Kling</h6>
    <span class="date">2 Days Ago</span>
    <p>Sed ac risus. Phasellus lacinia, magna a ullamcorper laoreet, lectus arcu pulvinar risus.</p>
    <a href="#" class="replay">Replay</a>
    </div>
    </div>
    <div class="comment-item">
    <div class="comment-img">
    <img src="assets/images/blog/comment-3.png" alt="Commenter">
    </div>
    <div class="comment-content">
    <h6>Andy Brekke</h6>
    ...
    <div class="comment-item">
    <div class="comment-img">
    <img src="assets/images/blog/comment-4.png" alt="Commenter">
    </div>
    <div class="comment-content">
    <h6>Colin Raynor</h6>
    ...
    <h3 class="inner-title">Write a Comment</h3>
    <form id="comment-form" name="comment_form" class="comment-form" action="sendmail.php.html" method="POST">
    <div class="row clearfix">
    <div class="col-md-6">
    <div class="form-group">
    <input type="text" name="first_name" id="name" class="form-control" value="" placeholder="Your Name" required="">
    </div>
    </div>
    <div class="col-md-6">
    <div class="form-group">
    ...
    <button class="theme-btn br-30 mt-30" type="submit" data-loading-text="Please wait...">Comment</button>
    </div>
    </div>
    </div>
    </form>
    ...
    <li><a href="blog-details.html">We Need to Rent a <br>Room For Our Party.</a></li>
    <li><a href="blog-details.html">National Program <br>Aids Fire Department</a></li>
    <li><a href="blog-details.html">Hard Drive Caclulator <br>is now available</a></li>
    <li><a href="blog-details.html">Services that the Brunswick <br>Facility Offers to Everyone</a></li>
    <li><a href="blog-details.html">Having Doubts? Call Our <br>Locks Mith in</a></li>
    </ul>
    </div>
    <div class="widget categories-widget">
    <h3 class="widget-title">Categories</h3>
    <ul class="list-style-one">
    <li><a href="#">Latest News <span>(10)</span></a></li>
    <li><a href="#">Business <span>(5)</span></a></li>
    <li><a href="#">Empowerment <span>(15)</span></a></li>
    <li><a href="#">Uncategorized <span>(25)</span></a></li>
    </ul>
    </div>
